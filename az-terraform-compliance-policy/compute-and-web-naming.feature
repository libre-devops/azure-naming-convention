Feature: Naming Convention For Compute and Web Items
  ...
  Scenario Outline: Naming Standard For App Service Environment
    ...
    Then its value must match the "ase-.*-(dev|dev2|mvp|ppd|prd|prd1|prd2|stg|tst|tst1|tst2|uat).*" regex
  ...
  Scenario Outline: Naming Standard For App Service plan
    ...
    When it has <name_key>
    Then it must have name
    Then its value must match the "plan-.*-(dev|dev2|mvp|ppd|prd|prd1|prd2|stg|tst|tst1|tst2|uat).*" regex
  ...
  Scenario Outline: Naming Standard For Availability Set
    ...
    When it has <name_key>
    Then it must have name
    Then its value must match the "avail-.*-(dev|dev2|mvp|ppd|prd|prd1|prd2|stg|tst|tst1|tst2|uat).*" regex
  ...
  Scenario Outline: Naming Standard For Disk Encryption Set
    ...
    When it has <name_key>
    Then it must have name
    Then its value must match the "des-.*-(dev|dev2|mvp|ppd|prd|prd1|prd2|stg|tst|tst1|tst2|uat).*" regex
  ...
  Scenario Outline: Naming Standard For Function App
    ...
    When it has <name_key>
    Then it must have name
    Then its value must match the "func-.*-(dev|dev2|mvp|ppd|prd|prd1|prd2|stg|tst|tst1|tst2|uat).*" regex
  ...
  Scenario Outline: Naming Standard For Shared Image Gallery
    ...
    When it has <name_key>
    Then it must have name
    Then its value must match the "gal-.*-(dev|dev2|mvp|ppd|prd|prd1|prd2|stg|tst|tst1|tst2|uat).*" regex
  ...
  Scenario Outline: Naming Standard For Managed Disk
    ...
    When it has <name_key>
    Then it must have name
    Then its value must match the "disk-.*-(dev|dev2|mvp|ppd|prd|prd1|prd2|stg|tst|tst1|tst2|uat).*" regex
  ...
  Scenario Outline: Naming Standard For Notification Hub
    ...
    When it has <name_key>
    Then it must have name
    Then its value must match the "ntf-.*-(dev|dev2|mvp|ppd|prd|prd1|prd2|stg|tst|tst1|tst2|uat).*" regex
  ...
  Scenario Outline: Naming Standard For Notification Hub Namespace
    ...
    When it has <name_key>
    Then it must have name
    Then its value must match the "ntfns-.*-(dev|dev2|mvp|ppd|prd|prd1|prd2|stg|tst|tst1|tst2|uat).*" regex
  ...
  Scenario Outline: Naming Standard For Snapshot
    ...
    When it has <name_key>
    Then it must have name
    Then its value must match the "snap-.*-(dev|dev2|mvp|ppd|prd|prd1|prd2|stg|tst|tst1|tst2|uat).*" regex
  ...
  Scenario Outline: Naming Standard For Static Site
    ...
    When it has <name_key>
    Then it must have name
    Then its value must match the "stapp-.*-(dev|dev2|mvp|ppd|prd|prd1|prd2|stg|tst|tst1|tst2|uat).*" regex
  ...
  Scenario Outline: Naming Standard For Windows Virtual Machine Scale Set
    ...
    When it has <name_key>
    Then it must have name
    Then its value must match the "vmss-.*-(dev|dev2|mvp|ppd|prd|prd1|prd2|stg|tst|tst1|tst2|uat).*" regex
  ...
  Scenario Outline: Naming Standard For Webapp
    ...
    When it has <name_key>
    Then it must have name
    Then its value must match the "app-.*-(dev|dev2|mvp|ppd|prd|prd1|prd2|stg|tst|tst1|tst2|uat).*" regex
